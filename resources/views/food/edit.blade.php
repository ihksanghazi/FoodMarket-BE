      ...
      <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div>
            ...
            <form action="{{ route('food.update',$item->id) }}" method="post" enctype="multipart/form-data" class="w-full">
              @csrf
              @method('put')
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-1/2 px-3">
                        ...
                        <input value="{{ old('rate') ?? $item->rate }}" name="rate" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" step="0.1" max="5" min="1" placeholder="Rate">
                    </div>
                    <div class="w-1/2 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
                            Types
